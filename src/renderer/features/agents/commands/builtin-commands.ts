...
2. Create the file .instructor/worktree.json with setup commands
...
Example output for .instructor/worktree.json:
{
  "setup-worktree": [
    "bun install",
...
Now analyze this project and create .instructor/worktree.json with the appropriate setup commands.`,
}
