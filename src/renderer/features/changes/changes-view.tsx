		...
		<ContextMenu>
			<ContextMenuTrigger asChild>
				<div
					data-file-item
					className={cn(
						"flex items-center gap-2 mx-1 px-2 py-2 rounded-md cursor-pointer",
						...
						<>
							...
							{totalCount === 0 ? (
								<div className="flex-1 flex flex-col items-center justify-center gap-1.5 px-4 text-center">
									...
									<div className="text-sm font-medium text-foreground">No changes yet</div>
									<div className="text-xs text-muted-foreground">Your working tree is clean.</div>
								</div>
							) : (
								<div
									ref={fileListRef}
									className="flex-1 overflow-y-auto outline-none py-1"
									tabIndex={0}
